...
- Provides a candidate low-ceremony API sketch for AdvisoryLane or lane with cadence, timeout or deadline, stale TTL, fallback, merge and telemetry hooks, and explains how it composes with existing actor behavior APIs.
