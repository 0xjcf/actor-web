...
- Evidence: Cross-repo agent-native interaction contract amendment | Filter capability discovery per caller, re-check authorization at execution, and preserve transport-agnostic Pong behaviors.
