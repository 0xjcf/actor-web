# Week 9 learning product: ecosystem ports adapters and authority
...
Build the guide, workbook, and lab for hexagonal architecture, functional core and imperative shell, provider-neutral ports, optional adapters, Actor-Web data-plane authority, FAS control-plane governance, Ignite projection authority, and cross-repository handoff contracts. Reconfirm live runtime-chain maturity when work begins rather than joining this supplemental curriculum to the product execution chain.

## Acceptance criteria

- Teach the source-of-truth ownership matrix for Actor-Web, FAS, Ignite Element, application behavior, and human final review.
- Reconfirm FAS control-plane conformance evidence at task start and label unavailable integration mappings as candidate or accepted target.
...
- Superseded before implementation by task-1785530240296 after the Week 8 edge still inherited depth 13.
