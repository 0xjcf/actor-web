...
Paste the **Prompt** section below into a fresh session in `/Users/joseflores/Development/actor-web`. Everything the new session needs is here; it does **not** have access to the prior conversation.
