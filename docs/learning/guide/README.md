...
| --- | --- | --- |
| [1. JavaScript concurrency and actor mailboxes](https://0xjcf.github.io/actor-web/learning/guide/01-javascript-concurrency-and-mailboxes.html) | If JavaScript is single-threaded, why do we need an actor concurrency model? | Current |
...
Return to the [learning-product home](https://0xjcf.github.io/actor-web/learning/) or open the
